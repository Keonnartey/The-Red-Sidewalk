  ...
  return (
    <div className="w-full h-full relative">
      ...
      <div className="absolute top-10 left-10 bg-[#d9d9d9] rounded-lg p-6 w-[350px] z-20">
        <h2 className="text-center text-2xl font-bold mb-6">FILTER YOUR SEARCH</h2>

        <div className="mb-6">
          <p className="text-center mb-3 font-medium">Type of Creature</p>
        ...
        <div className="mb-6">
          <p className="text-center mb-3 font-medium">Location</p>
          <Input className="bg-white border-none text-center" placeholder="Enter location" defaultValue="USA" />
        </div>

        <div className="mb-6">
          <p className="text-center mb-3 font-medium">Season</p>
          <div className="flex justify-between px-8">
            <button className="p-2 hover:bg-gray-200 rounded-full transition-colors">
              <SunIcon />
            </button>
        ...
        <div className="mb-2">
          <p className="text-center mb-3 font-medium">Time of Day</p>
...
// Custom Icons
function GhostIcon({ color = "black", size = 24 }) {
  return (
...
function BigfootIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function DragonIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function AlienIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function SunIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function CloudIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function LeafIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function SnowflakeIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function DayIcon({ color = "black", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function NightIcon({ color = "white", size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
